...
<p>
	...
	<ul>
		...
		<li>
			<p>Don't code CSS for the page. <strong>Code it for a system.</strong></p>
		</li>
		<li>
			<p><em>Performance:</em> Pull in style sheets when you need them.</p>
		</li>
		<li>
			<p><em>Performance:</em> Smaller rule sets make it easier on browsers - googel recommends a single ID or class selector</p>
		</li>
		<li>
			<p>
				The list of <a href="https://smacss.com/workshops/resources">resources</a> that were mentioned in the workshop
			</p>
		</li>
